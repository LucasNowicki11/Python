class Celular_gama_baja():
    ...
    def sacar_fotos(self):
        print(f'El celular saco una foto {self.calidad_fotos}')
    def __str__(self):
        return f'\nModelo: {self.modelo}\nPrecio: {self.precio}\nMemoria: {self.memoria}\nCalidad: {self.calidad_fotos}'
...
class Celular_gama_media(Celular_gama_baja):
    ...
    def grabar_tiktoks(self):
        print(f'Estamos grabando tiktoks para hacernos famosos en {self.calidad_videos}')

    def __str__(self):
        return f'\nModelo: {self.modelo}\nPrecio: {self.precio}\nMemoria: {self.memoria}\nCalidad: {self.calidad_fotos}\nVideos: {self.calidad_videos}'
